...
if (form && formStatus) {
  form.addEventListener("submit", async (event) => {
    ...
    const fallbackEmail = form.getAttribute("data-mail-fallback") || "leelawtax@gmail.com";
    ...
    const body = [
      ...
      window.location.href = `mailto:${fallbackEmail}?subject=${encodeURIComponent("홈페이지 상담 신청")}&body=${encodeURIComponent(body)}`;
